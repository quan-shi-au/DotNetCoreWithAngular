...
describe('partner list component', () => {
    ...
    beforeEach(() => {
        ...
        var httpClientStub = new HttpClient(null);
        var environmentSpecificServiceStub = new EnvironmentSpecificService(new Http(null, null));
        var utilityServiceStub = new UtilityService(null);

        dashboardService = new DashboardService(httpClientStub, utilityServiceStub, environmentSpecificServiceStub);
    ...
    it('overview doesn\'t lose informatoin', () => {
